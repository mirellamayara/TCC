...
include("conexao.php");
    ...
    $sql="INSERT INTO aluno(nome, endereco, datadenascimento, cpf, telefone, email, senha, redessociais ) 
    VALUES('$nome','$endereco','$datadenascimento','$cpf', '$telefone','$email' ,'$senha','$redessociais')";
