...
--
-- Host: 127.0.0.1
-- Tempo de geração: 05/09/2024 às 13:30
...
INSERT INTO `curso` (`idcurso`, `nomedocurso`, `duracao`, `datainicio`, `datatermino`) VALUES
...
(24, 'Bateria', '3', '2024-08-22', '2024-08-23'),
...
--
ALTER TABLE `inscricao`
  MODIFY `idinscricao` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=119;
